...
INSERT INTO "new_Pr0grammItem" ("audio", "cold", "created", "createdAt", "down", "flags", "fullsize", "gift", "height", "id", "image", "mark", "promoted", "source", "thumb", "up", "updatedAt", "user", "userId", "width") SELECT "audio", "cold", "created", "createdAt", "down", "flags", "fullsize", "gift", "height", "id", "image", "mark", "promoted", "source", "thumb", "up", "updatedAt", "user", "userId", "width" FROM "Pr0grammItem";
